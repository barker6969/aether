...
export const WindowChrome = () => {
  return (
    <div
      ...
      className="h-9 bg-black border-b border-white/10 flex items-center justify-between px-3 select-none flex-shrink-0"
    >
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="w-8 h-9 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/5 transition-colors"
        >
        ...
        <button
          ...
          className="w-8 h-9 flex items-center justify-center text-white/40 hover:text-white hover:bg-red-500 transition-colors"
        >
